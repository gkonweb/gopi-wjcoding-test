...
namespace Webjet.Services
{
    ...
    public class FilmWorldService : IFilmWorldService
    {
        ...
        private const string Source = "Filmword";
        private const string IDPrefix = "fw";
        ...
        public async Task<List<Movie>> GetMovies()
        {
            ...
            {
                _logger.LogError(ex, "Error calling Filmword");
        ...
        public async Task<MovieDetail?> GetMovieDetails(string movieId)
        {
            ...
            {
                _logger.LogError(ex, "Error fetching movie details for {MovieId} from Filmword.", movieId);
                return null;
            }
        }
    }
